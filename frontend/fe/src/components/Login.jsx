    ...
    return (
        <div style={{ backgroundImage: `url(${img})`, height: '100vh' }} className='bg-cover'>
            <div className='flex justify-between pt-3'>
                <h1 className='text-xl ml-3 text-black font-bold self-center pl-4'>Journarism</h1>
            ...
            <div className='pt-40 pl-40'>
                <div className='self-center box-border w-[25%] h-auto bg-black bg-opacity-40 shadow-2xl rounded-2xl'>
                    <h1 className='text-white text-3xl pl-10 pt-10 font-bold'>Login</h1>
                    <form className='flex flex-col space-y-3 pt-10 pl-10' onSubmit={handleSubmit}>
                        ...
                        <div className='flex justify-center pr-10 pt-3'>
                            <button className='bg-gray-700 w-[25%]  h-8 text-white rounded-lg hover:font-bold' type='submit'>Login</button>
                        </div>
                    </form>

                    <div className='pt-4 pl-16 space-x-1'>
                        <button className='hover:text-red-500 pb-3'>
                            <Link to="/reg">Not Registered? Create account</Link>
                        </button>
                    </div>
                </div>
            </div>
