    ...
    return (
        <div>
            ...
            <div>
                ...
                <h1 className='text-xl ml-3 text-white font-bold self-center pl-4'>
                    Journarism
                </h1>
                <ul className='flex flex-row space-x-7 text-white self-center mr-6'>
                    <li>Home</li>
                    <li>About</li>
                    ...
                    <div className='pt-40 pl-40'>
                        <div className='self-center box-border w-[25%] h-auto bg-black bg-opacity-40 shadow-2xl rounded-2xl'>
                            <h1 className='text-white text-3xl pl-10 pt-10 font-bold'>{isRegistering ? 'Register' : 'Login'}</h1>
